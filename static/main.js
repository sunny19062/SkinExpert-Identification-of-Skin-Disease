...
function displayResult(data) {
  ...
  var iframe = document.getElementById('disease-iframe');

  // Set the source of the iframe to the corresponding HTML file
  var url = "/Diseases/" + predictedClassName;
  iframe.src = url;
  console.log(url);
  // var iframe = document.getElementById('disease-iframe');
                                                  
  // // Set the source of the iframe to the corresponding HTML file
  // sr = "{{ url_for("+predictedClassName+") }}";
  // iframe.src=sr
  // console.log(sr)                                                                                               
}
